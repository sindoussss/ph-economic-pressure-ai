...
3. **A trailing-preliminary-months robustness re-test** — dropping trailing preliminary observations left the edge intact, a check that had *correctly rejected* an apparently significant transport-CPI edge in the same audit.
